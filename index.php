...
<head>
  ...
  <title>Artisanal Tuscan Bruschetta & Evening Banquets — Bruschettafeast</title>
  ...
  <link rel="canonical" href="https://bruschettafeast.com/">
...
<body>
  ...
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Bruschettafeast Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Bruschettafeast</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Bruschettafeast</div>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@bruschettafeast.com</p>
    </div>
  </div>
      ...
      <div style="display: grid; grid-template-columns: 1.15fr 1fr; gap: 4rem; align-items: center;">
        <div>
          ...
          <h1 style="margin-bottom: 1.2rem; font-size: clamp(2.4rem, 4.5vw, 3.8rem); line-height: 1.15; color: #1C120C;">
            The Convivial Splendor of the Tuscan Evening Feast
          </h1>
          <p class="lead" style="margin-bottom: 1.8rem; font-size: 1.12rem; line-height: 1.75; color: #3A2E26;">
            Wood-fired country sourdough bruschetta rubbed with fresh garlic, drizzled with first-press single-estate Tuscan olive oil, and topped with heirloom San Marzano pomodori at 181 Mercer Street.
          </p>
        ...
        <div style="position: relative;">
          <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-lg); border: 1px solid var(--color-border); background: #FFF;">
            <img src="/assets/images/grand_feasting_table_spread.jpg" alt="Bruschettafeast grand banquet feasting table" style="width: 100%; height: auto;">
          </div>
      ...
      <div class="grid-4">
        ...
        <div class="paid-product-card">
          ...
          <div class="paid-product-img-wrap">
            <img src="/assets/images/herb_infused_olive_oil_bread.jpg" alt="The Mercer Classic Pomodoro Bruschetta">
          </div>
        ...
        <div class="paid-product-card">
          ...
          <div class="paid-product-img-wrap">
            <img src="/assets/images/dish_heirloom_beet_burrata.jpg" alt="The Stracciatella & Summer Truffle Tartine">
          </div>
          <div class="paid-product-body">
        ...
        <div class="paid-product-card">
          ...
          <div class="paid-product-img-wrap">
            <img src="/assets/images/woodfired_sourdough_crust.jpg" alt="The Wood-Fired Porcini & Sourdough Crust">
          </div>
          <div class="paid-product-body">
        ...
        <div class="paid-product-card">
          ...
          <div class="paid-product-img-wrap">
            <img src="/assets/images/truffle_handmade_pasta_plate.jpg" alt="Handcrafted Tagliolini with Shaved White Truffle">
          </div>
          <div class="paid-product-body">
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: 1fr 1.15fr; gap: 4rem; align-items: center;">
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md); border: 1px solid var(--color-border);">
          <img src="/assets/images/dish_artisan_sourdough_butter.jpg" alt="Blistered wood-fired artisan levain sourdough bread">
        </div>
        <div>
          ...
          <p>
            True Tuscan bruschetta is an exercise in deceptive simplicity where four pristine raw components harmonize under intense hearth heat. At Bruschettafeast, we refuse shortcuts: each element is calibrated to achieve textural transcendence.
          </p>
  ...
  <section class="section" style="background: #FAF7F2;">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Pillars of the Bruschettafeast Table</h2>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="grid-2">
        ...
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md); border: 1px solid var(--color-border);">
          <img src="/assets/images/harvest_salad_platter.jpg" alt="Heirloom seasonal harvest salad platter">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="background: #FAF7F2;">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p class="text-muted" style="max-width: 650px; margin: 0.8rem auto 0;">
          Chemical metrology comparing Bruschettafeast single-estate unfiltered cold-press EVO against commercial supermarket blends.
        </p>
      </div>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Bruschettafeast Single-Estate Tuscan EVO</th>
      ...
      <div class="grid-4">
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/hero_candlelit_evening_ambiance.jpg" alt="The Candlelit Evening Ambiance">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/chef_plating_gourmet_pass.jpg" alt="The Chef's Hearth Kitchen Pass">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/sommelier_cellar_selection_bottles.jpg" alt="The Sommelier Cellar Vault">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/candlelight_dining_table.jpg" alt="The Convivial Grand Banquet Hall">
  ...
  <section class="section" style="background: #FAF7F2;">
    <div class="container">
      <div class="grid-2">
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md); border: 1px solid var(--color-border);">
          <img src="/assets/images/private_alcove_dining_room.jpg" alt="Private dining alcove at 181 Mercer Street">
        </div>
        <div>
      ...
      <div class="faq-section" style="margin-top: 2rem;">
        <div class="faq-item">
          ...
          <div class="faq-answer">
            Dinner reservations for our 24 nightly covers are released on the first day of each month at 9:00 AM EST for the following month. For private buyout inquiries of our entire Mercer Street dining salon, please contact concierge@bruschettafeast.com or call +1-888-777-5845.
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question" aria-expanded="false">
  ...
  <!-- Mandatory Global Site Footer (Horizontal Layout) -->
  <footer class="site-footer horizontal-footer">
    <div class="container">
      <!-- Tier 1: Brand, Tagline & Contact Strip -->
      <div class="footer-h-brand-row">
        <div class="footer-h-brand-left">
          <div class="footer-brand">◈ Bruschettafeast</div>
          <div class="footer-h-tagline">Haute Artisanal Excellence &bull; SoHo Manhattan</div>
        </div>
        <div class="footer-h-contact-bar">
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@bruschettafeast.com</div>
        </div>
      </div>

      <!-- Tier 2: Atelier Navigation (Horizontal Row) -->
      <div class="footer-h-nav-row">
        <div class="footer-h-nav-label">Atelier Navigation</div>
        <ul class="footer-h-links">
      ...
      <!-- Tier 3: Authoritative Treatises (Horizontal Row) -->
      <div class="footer-h-nav-row">
        <div class="footer-h-nav-label">Authoritative Treatises</div>
        <ul class="footer-h-links">
      ...
      <!-- Tier 4: Manhattan Salon & Atelier Description (Horizontal Row) -->
      <div class="footer-h-info-row">
        <div class="footer-h-desc">
        ...
        <div class="footer-h-hours">
          <span class="hours-badge">MANHATTAN SALON</span>
          <span>Mon – Sat: 10:00 AM – 7:00 PM EST &bull; Sunday: By Appointment</span>
        </div>
      </div>

      <!-- Tier 5: Copyright & Legal Bottom Bar -->
      <div class="footer-bottom">
        <p>&copy; 2026 Bruschettafeast Ltd. All Rights Reserved. Master craft at 181 Mercer Street, New York, NY 10012.</p>
